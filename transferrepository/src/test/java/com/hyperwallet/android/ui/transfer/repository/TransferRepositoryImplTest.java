...
public class TransferRepositoryImplTest {
    ...
    public void testCreateTransfer_onSuccess() throws JSONException {
        ...
        verify(mCreateTransferCallback, never()).onError(any(HyperwalletErrors.class));
    ...
    public void testCreateTransfer_onFailure() throws Exception {
        ...
        HyperwalletErrors capturedErrors = mErrorsArgumentCaptor.getValue();
        assertThat(capturedErrors, is(notNullValue()));
        assertThat(capturedErrors.getErrors(), Matchers.<HyperwalletError>hasSize(1));
    ...
    public void testScheduledTransfer_onSuccess() throws Exception {
        ...
        verify(mScheduleTransferCallback, never()).onError(any(HyperwalletErrors.class));

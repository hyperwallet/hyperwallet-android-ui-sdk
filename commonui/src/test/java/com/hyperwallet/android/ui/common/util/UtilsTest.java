...
public class UtilsTest {
    private Map<String, String> currenciesMap = new HashMap<String, String>() {
        {
            put("ALL", "ALL1,000,000");         // Albania Currency
            put("ARS", "ARS1,000,000.00");      // Argentina Currency
            put("AMD", "AMD1,000,000.0");       // Armenia Currency
            ...
            put("COP", "COP1,000,000");         // Colombia Currency
            ...
            put("PKR", "PKR1,000,000");         // Pakistan Currency
            ...
            put("VND", "VND1,000,000");         // Vietnam Currency
        }
    };

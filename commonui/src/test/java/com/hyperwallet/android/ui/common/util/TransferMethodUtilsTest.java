...
public class TransferMethodUtilsTest {
    ...
    public void getTransferMethodDetail_returnsCardDetails() {
        ...
        when(mContext.getString(eq(R.string.transfer_method_list_item_description),
                eq("0006"))).thenReturn(
                "Ending on 0006");
    ...
    public void getTransferMethodDetail_returnsPaperCheckDetails() {
        ...
        verify(mContext, never()).getString(eq(R.string.transfer_method_list_item_description),
                anyString());
    }
}
